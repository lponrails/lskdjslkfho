...
def predict_image(image_bytes: bytes, confidence_threshold: int = 40):
...
def predict_images(images_bytes: list[bytes], confidence_threshold: int = 40):
    response = requests.post(
...
def predict_video(video_bytes: bytes, confidence_threshold: int = 40):
    response = requests.post(
